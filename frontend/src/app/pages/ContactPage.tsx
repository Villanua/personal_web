...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900 font-sans selection:bg-zinc-900 selection:text-white">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <section className="mb-40">
            ...
            >
              ...
              >
                <p>{t.contactIntro1 || "¿Tienes un proyecto en mente o quieres colaborar? Me encantaría escucharte."}</p>
                <p>{t.contactIntro2 || "Ya sea un desafío técnico, una idea innovadora o simplemente una conversación sobre robótica e IA, estaré encantado de conectar."}</p>
              </motion.div>
            </motion.div>
          </section>
          ...
          <section className="mb-40">
            ...
            >
              <h2 className="text-2xl font-bold tracking-tight">{t.getInTouch || "Ponte en contacto"}</h2>
              <span className="text-[10px] text-zinc-400 uppercase tracking-widest">{t.contactLabel || "Contacto"}</span>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-16">
              ...
              >
                <div className="group py-16 border-b border-zinc-50 last:border-0 hover:bg-zinc-50/30 transition-all duration-300 px-6 -mx-6 rounded-lg">
                  <h3 className="text-2xl font-medium tracking-tight mb-4">Email</h3>
                  <a 
                    href="mailto:NachoViCu16@gmail.com"
                    className="text-lg text-zinc-600 hover:text-zinc-900 transition-colors font-light"
                  >
                    NachoViCu16@gmail.com
                  </a>
                  <p className="text-sm text-zinc-400 mt-4">{t.emailResponse || "Responderé lo antes posible"}</p>
                </div>
              </motion.div>
              ...
              >
                <div className="group py-16 border-b border-zinc-50 last:border-0 hover:bg-zinc-50/30 transition-all duration-300 px-6 -mx-6 rounded-lg">
                  <h3 className="text-2xl font-medium tracking-tight mb-8">Redes Sociales</h3>
                  <div className="space-y-6">
                    <a 
                      href="https://linkedin.com/in/ignacio-villanua-cuenca/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-4 text-zinc-600 hover:text-zinc-900 transition-colors group"
                    >
                      <svg className="w-6 h-6 group-hover:translate-x-1 transition-transform" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
      ...
      <footer className="py-20 bg-zinc-900 text-white mt-40">
